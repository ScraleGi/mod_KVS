 ...
 * TableTopButton
 * 
 * Renders a top bar for tables with a title and up to three action buttons.
 * - button1: "Add New" (primary action)
 * - button2: "Back to Home" (secondary action)
 * - button3: "Deleted" or "Deleted Areas" (danger/restore action, always shown)
 * - children: Optional additional elements (e.g., filters, custom controls)
 * - auth: If true, uses a different color scheme for button1 and button3
 */
export default function TableTopButton({
    ...
    // Authenticated variant: lighter blue for add, red for deleted
    if (auth === true) {
        return (
        ...
        // Default variant: blue for add, red hover for deleted
        return (
            <div className="flex items-center justify-between mb-8">
                <h1 className="text-2xl font-bold text-gray-900 tracking-tight">{title}</h1>
                <div className="flex gap-2">
