        ...
        <>
          ...
          <div className="fixed top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 bg-white rounded-xl shadow-lg p-6 z-50 w-80">
            <div className="text-center mb-5">
              ...
              <h3 className="text-lg font-semibold text-gray-900 mb-2">Kursanmeldung entfernen</h3>
              <p className="text-gray-600 text-sm">
                Sind Sie sicher, dass Sie diese Kursanmeldung entfernen möchten? Diese Aktion kann nicht rückgängig gemacht werden.
              </p>
            </div>
